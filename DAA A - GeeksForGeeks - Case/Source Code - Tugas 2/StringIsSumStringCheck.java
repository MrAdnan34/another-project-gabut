...
public class StringIsSumStringCheck {
    ...
    public static String stringSum(String str1, String str2) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            // Menggunakan .charAt() untuk mengakses tiap karakter di dalam String
            int ds = ((str1.charAt(m - 1 - i) - '0') + (str2.charAt(n - 1 - i) - '0') + carry) % 10;
            carry = ((str1.charAt(m - 1 - i) - '0') + (str2.charAt(n - 1 - i) - '0') + carry) / 10;

            // Menggunakan .toString() untuk mengkonversi "int ds" sebelumnya menjadi String yang nanti akan di-return dalam method ini
    ...
    public static boolean checkSumStrUtil(String str, int beg, int len1, int len2) {
        ...
        // Cek apakah s3 sama dengan substring berikutnya dalam string utama
